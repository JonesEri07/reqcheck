...
--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "billing_plan" varchar(20) DEFAULT 'FREE' NOT NULL;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "webhook_url" text;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "webhook_secret" text;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "whitelist_urls" text[] DEFAULT '{}';--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "onboarding_complete" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "quick_setup_did_complete" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "stop_widget_at_free_cap" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "default_question_time_limit_seconds" integer;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "default_pass_threshold" integer DEFAULT 60 NOT NULL;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "default_question_count" integer DEFAULT 5 NOT NULL;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "tag_match_weight" numeric(3, 2) DEFAULT '1.5' NOT NULL;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "tag_no_match_weight" numeric(3, 2) DEFAULT '1.0' NOT NULL;--> statement-breakpoint
ALTER TABLE "teams" ADD COLUMN "sync_challenge_questions" varchar(20) DEFAULT 'NONE' NOT NULL;--> statement-breakpoint
...
CREATE INDEX "teams_subscription_status_idx" ON "teams" USING btree ("subscription_status");