...
export default function LeverIntegrationPage() {
  return (
    <DocsPageWrapper>
      <div className="mb-12">
        <h1
        ...
        <p className="text-muted-foreground text-lg">
          Full integration with Lever ATS coming in Q2 2026.
        </p>
      </div>
      ...
      <div className="space-y-8">
        <Card id="coming-soon">
          <CardHeader>
            ...
            <CardDescription>
              We&apos;re working on a full integration with Lever
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p>
              We&apos;re currently developing a comprehensive integration with
              Lever ATS that will include:
            </p>
        ...
        <div className="flex items-center justify-between rounded-lg border p-6">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              We&apos;ll let you know when the Lever integration is available.
            </p>
          </div>
