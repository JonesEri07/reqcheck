...
import { Settings, Shield, Activity, Bell } from "lucide-react";
import { cn } from "@/lib/utils";

const navItems = [
  {
    href: "/app/user-settings/general",
    icon: Settings,
    label: "General",
  },
  {
    href: "/app/user-settings/notifications",
    icon: Bell,
    label: "Notifications",
  },
  {
    href: "/app/user-settings/activity",
    icon: Activity,
    label: "Activity",
  },
  {
    href: "/app/user-settings/security",
    icon: Shield,
    label: "Security",
  },
];
